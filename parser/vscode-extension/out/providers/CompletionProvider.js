...
exports.SdoxCompletionProvider = exports.TAG_SCHEMA = void 0;
...
class SdoxCompletionProvider {
    ...
    getTagCompletions() {
        ...
        for (const tag of TAG_SCHEMA) {
            ...
            item.documentation = new vscode.MarkdownString(`**#${tag.name}** — ${tag.description}\n\n` +
    ...
    getValueCompletions(tagName, attrName) {
        const tag = TAG_SCHEMA.find(t => t.name === tagName);
        if (!tag) {
            return [];
        }
